...
type PageDetailsController struct {
	service services.PageDetailsService
	logger  *slog.Logger
}

func NewPageDetailsController(service services.PageDetailsService, logger *slog.Logger) *PageDetailsController {
	if service == nil {
...
// @Success 200 {object} dto.PageDetailsResponse
